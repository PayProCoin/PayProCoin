...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/payprocoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("PayProCoin"),
     ...
     * override -datadir in the payprocoin.conf file in the default data directory
     * (to be consistent with payprocoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
