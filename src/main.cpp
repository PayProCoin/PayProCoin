...
#if defined(NDEBUG)
# error "PayProCoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight, int64_t nFees)
{
    ...
    // Subsidy is cut in half every 105,000 blocks which will occur approximately every years.
    nSubsidy >>= halvings;
...
static const int64_t nTargetTimespan = 1 * 24 * 60 * 60; // one day
