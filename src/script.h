...
#ifndef H_PAYPROCOIN_SCRIPT
#define H_PAYPROCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPayProCoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, PayProCoin always counted CHECKMULTISIGs
