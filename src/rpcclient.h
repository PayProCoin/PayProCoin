...
#ifndef _PAYPROCOINRPC_CLIENT_H_
#define _PAYPROCOINRPC_CLIENT_H_ 1
...
/** Show help message for payprocoin-cli.
 ...
 *
 * @note the argument can be removed once payprocoin-cli functionality is removed from payprocoind
 */
