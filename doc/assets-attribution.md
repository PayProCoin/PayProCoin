The following is a list of assets used in the payprocoin source and their proper attribution.
...
* License: MIT
* Site: [https://payprocointalk.org/index.php?topic=15276.0](https://payprocointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original payprocoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/payprocoin.icns, src/qt/res/src/payprocoin.svg,
	src/qt/res/src/payprocoin.ico, src/qt/res/src/payprocoin.png,
	src/qt/res/src/payprocoin_testnet.png, docs/payprocoin_logo_doxygen.png,
