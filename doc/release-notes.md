PayProCoin Core version 0.9.2 is now available from:

  https://payprocoin.org/bin/0.9.2/
...
Please report bugs using the issue tracker at github:
  ...
  https://github.com/payprocoin/payprocoin/issues
...
installer (on Windows) or just copy over /Applications/PayProCoin-Qt (on Mac) or
payprocoind/payprocoin-qt (on Linux).
...
- Lower paytxfee warning threshold from 0.25 PRO to 0.01 PRO
...
- Fix "Start payprocoin on system login"
