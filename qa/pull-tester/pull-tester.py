#!/usr/bin/python
# Copyright (c) 2013 The PayProCoin Core developers
...
Contact BlueMatt on freenode if something looks broken."""
    ...
    # Remove old PayProCoinPullTester comments (I'm being lazy and not paginating here)
...
def testpull(number, comment_url, clone_url, commit):
    ...
    script += " ${BUILD_PATH} ${MINGW_DEPS_DIR} ${SCRIPTS_DIR}/PayProCoindComparisonTool_jar/PayProCoindComparisonTool.jar 0 6 ${OUT_DIR}"
...
environ_default("CLONE_URL", "https://github.com/payprocoin/payprocoin.git")
...
environ_default("BUILD_PATH", "/mnt/payprocoin")
...
environ_default("GITHUB_REPO", "payprocoin/payprocoin")
